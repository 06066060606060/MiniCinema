  <nav class="mt-2 bg-gray-100 rounded-lg shadow">
      <div class="flex flex-col mx-4 md:flex-row md:justify-between md:items-center">
          <div class="flex items-center justify-between">
              ...
              <form class="form-inline my-2 lg:my-0" method="GET" action="{{ route('/search') }}">
                @csrf
                  <input name="query" type="search" placeholder="Search"
                      class="w-1/2 py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md focus:border-red-700 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-red-300"">
                    <button class="
                      
                      block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-red-500 md:mx-2 md:w-auto hover:ease-in ">search
                  </button>
              </form>
          </div>
